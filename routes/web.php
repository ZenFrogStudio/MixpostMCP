...
Route::middleware([
    ...
    ->group(function () {
        ...
        Route::prefix('accounts')->name('accounts.')->group(function () {
            ...
            // The composer reads this while editing a post so the TikTok audience dropdown offers
            // what the creator can actually use. See TikTokCreatorInfoController.
            Route::get('{account}/tiktok/creator-info', TikTokCreatorInfoController::class)->name('tiktokCreatorInfo');
