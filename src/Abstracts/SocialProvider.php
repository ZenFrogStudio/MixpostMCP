...
abstract class SocialProvider implements SocialProviderContract
{
    ...
    // Per-post options this provider accepts, rendered by the post composer.
    // Each item: ['key' => string, 'label' => string, 'type' => text|textarea|select|checkbox, 'default' => mixed]
    // A 'select' also needs 'choices' => ['value' => 'Label'].
