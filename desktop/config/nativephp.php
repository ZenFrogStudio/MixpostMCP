...
return [
    ...
    'cleanup_exclude_files' => [
        ...
        'node_modules',
        '*/tests',
        'storage/app/mixpostmcp-media/*', // dev uploads must not ship in the installer
    ],
     ...
     */
    'queue_workers' => [
        // Publishes run on 'publish-post'; video uploads can take minutes, hence the generous timeout.
        'default' => [
            'queues' => ['default', 'publish-post'],
            'memory_limit' => 512,
            'timeout' => 900,
            'sleep' => 3,
        ],
