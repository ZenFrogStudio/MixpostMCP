        ...
        <HorizontalGroup class="mt-lg">
            ...
            <template #footer>
                <p class="text-sm text-gray-500">
                    Must match the access level of your app in the X developer portal. Each tier caps
                    how many posts you may publish: <strong>Free</strong> allows roughly 1,500 a month,
                    <strong>Basic</strong> roughly 50,000 app-wide, and <strong>Pay as you go</strong> bills
                    per post with no monthly cap. Once the cap is reached X rejects every publish until the
                    next billing cycle — check your
                    <a href="https://developer.x.com/en/portal/dashboard" class="link" target="_blank">portal dashboard</a>
                    if posts start failing for no visible reason.
                </p>
