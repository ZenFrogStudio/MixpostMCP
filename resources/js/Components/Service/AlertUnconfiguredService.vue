...
<template>
    <div v-if="any" class="mb-md">
        <Alert variant="warning" :closeable="false" class="mb-md">
            ...
            <p v-if="!isConfigured.linkedin">You have not configured LinkedIn service.</p>
            <p v-if="!isConfigured.tiktok">You have not configured TikTok service.</p>
            <p v-if="!isConfigured.youtube">You have not configured YouTube service.</p>
