...
const features = [
    ...
    {
        name: 'Webhooks',
        desc: 'A powerful feature designed to enhance your workflow by enabling real-time communication between MixpostMCP and your favorite external services.',
    },
    {
        name: 'API',
        desc: 'An advanced feature that opens up a world of possibilities by allowing third-party services to seamlessly communicate with your MixpostMCP instance.',
    },
    {
